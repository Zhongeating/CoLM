...
!-----------------------------------------------------------------------
   ...
   attributes(device) SUBROUTINE rain_snow_temp (patchtype,&
...
!-------------------------- Local Variables ----------------------------
   ...
   logical  :: t_glaciers               ! true: glacier column
...
! wet-bulb temperature
      ...
      IF (d_DEF_precip_phase_discrimination_scheme == 1) THEN
      ...
      ELSEIF (d_DEF_precip_phase_discrimination_scheme == 2) THEN
         t_glaciers = .false.
         IF (patchtype == 3) t_glaciers = .true.
      ...
      ELSEIF (d_DEF_precip_phase_discrimination_scheme == 3) THEN
   ...
   attributes(device) SUBROUTINE NewSnowBulkDensity(forc_t,forc_us,forc_vs,bifall)
!=======================================================================
...
!=======================================================================
   ...
   attributes(device) SUBROUTINE hydromet_temp(ppa, pta, pqa, pti)
!-----------------------------------------------------------------------------
! !DESCRIPTION
...
END MODULE MOD_RainSnowTemp_CUDA
