...
!-----------------------------------------------------------------------
   ...
   attributes(device) SUBROUTINE GroundFluxes (zlnd, zsno, hu, ht, hq, hpbl, &
...
!-------------------------- Local Variables ----------------------------
   ...
   real(r8) :: &
         t_beta,       &! coefficient of conective velocity [-]
...
END MODULE MOD_GroundFluxes_CUDA
