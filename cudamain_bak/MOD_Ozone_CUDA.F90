...
CONTAINS
   ...
   attributes(device) SUBROUTINE CalcOzoneStress (o3coefv,o3coefg, forc_ozone, forc_psrf, th, ram, &
...
!-----------------------------------------------------------------------
   ...
   real(r8), parameter :: nonwoodyCondSlope    = 0._r8      ! units = per mmol m^-2
      ...
      IF(.not. d_DEF_USE_OZONEDATA)THEN
