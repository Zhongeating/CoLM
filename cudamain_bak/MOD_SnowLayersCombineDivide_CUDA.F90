...
MODULE MOD_SnowLayersCombineDivide_CUDA
...
!-----------------------------------------------------------------------
   ...
   attributes(device) SUBROUTINE snowcompaction (lb,deltim,imelt,fiold,&
...
! Pressure of overlying snow
   ...
   attributes(device) SUBROUTINE winddriftcompaction(bi,forc_wind,dz,zpseudo,mobile,compaction_rate)
...
! !USES:
   ...
   !-----------------------------------------------------------------------
   attributes(device) SUBROUTINE snowlayerscombine (lb,snl, &
...
! Reset the node depth and the depth of layer interface
   ...
   attributes(device) SUBROUTINE snowlayersdivide (lb,snl,z_soisno,dz_soisno,zi_soisno,wliq_soisno,wice_soisno,t_soisno)
...
!                   'and combined into underlying neighbor'
   ...
   attributes(device) SUBROUTINE combo ( dz_soisno, wliq_soisno, wice_soisno, t, &
                     dz2, wliq2, wice2, t2 )
...
!-----------------------------------------------------------------------
   ...
   attributes(device) SUBROUTINE SnowLayersCombine_snicar (lb,snl, &
              z_soisno,dz_soisno,zi_soisno,wliq_soisno,wice_soisno,t_soisno,scv,snowdp,&
...
!-----------------------------------------------------------------------
   ...
   attributes(device) SUBROUTINE SnowLayersDivide_snicar (lb,snl,z_soisno,dz_soisno,zi_soisno,&
...
END MODULE MOD_SnowLayersCombineDivide_CUDA
! ---------- EOP ------------
