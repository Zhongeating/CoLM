...
MODULE MOD_Hydro_SoilFunction_CUDA
...
CONTAINS
   ...
   !-------------------------------------
   attributes(device) SUBROUTINE get_derived_parameters_vGM ( &
   ...
   !------------------------------------------------------------------
   attributes(device) real(r8) FUNCTION soil_hk_from_psi (psi, &
   ...
   !-----------------------------------------------------------------
   attributes(device) real(r8) FUNCTION soil_psi_from_vliq (vliq, &
   ...
   !------------------------------------------------------------------
   attributes(device) real(r8) FUNCTION soil_vliq_from_psi (psi, &
         porsl, vl_r, psi_s, nprm, prms)
...
END MODULE MOD_Hydro_SoilFunction_CUDA
