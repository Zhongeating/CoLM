...
MODULE MOD_SoilSurfaceResistance_CUDA
! -----------------------------------------------------------------------
! !DESCRIPTION:
...
!-----------------------------------------------------------------------
   ...
   attributes(device) SUBROUTINE SoilSurfaceResistance (nl_soil,forc_rhoair,hksati,porsl,psi0, &
#ifdef Campbell_SOIL_MODEL
                              bsw, &
#endif
#ifdef vanGenuchten_Mualem_SOIL_MODEL
...
END MODULE MOD_SoilSurfaceResistance_CUDA
! ---------- EOP ------------
