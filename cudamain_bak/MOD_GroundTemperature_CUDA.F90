...
MODULE MOD_GroundTemperature_CUDA
...
!-----------------------------------------------------------------------
   ...
   attributes(device) SUBROUTINE GroundTemperature (patchtype,is_dry_lake,lb,nl_soil,deltim,&
...
! net ground heat flux into the surface and its temperature derivative
      ...
      IF (d_DEF_USE_SNICAR .and. lb < 1) THEN
      ...
      ELSE
         ...
         IF (abs(sabg_soil+sabg_snow-sabg)>1.e-6 .or. abs(hs_soil+hs_snow-hs)>1.e-6) THEN
            print *, "MOD_GroundTemperature_CUDA.F90: Error in spliting soil and snow surface!"
...
! set up vector r and vectors a, b, c that define tridiagonal matrix
      ...
      ! the first layer
      IF (j<1 .and. d_DEF_SPLIT_SOILSNOW) THEN ! snow covered and split soil and snow
...
END MODULE MOD_GroundTemperature_CUDA
