MODULE MOD_FrictionVelocity_CUDA
...
!-----------------------------------------------------------------------
   ...
   attributes(device) SUBROUTINE moninobuk(hu,ht,hq,displa,z0m,z0h,z0q,obu,um,&
...
! humidity profile
   ...
   attributes(device) SUBROUTINE moninobukm(hu,ht,hq,displa,z0m,z0h,z0q,obu,um,displat,z0mt,&
...
! humidity profile
   ...
   attributes(device) real(r8) FUNCTION kmoninobuk(displa,obu,ustar,z)
!-----------------------------------------------------------------------
! !DESCRIPTION:
...
!-----------------------------------------------------------------------
   ...
   attributes(device) real(r8) FUNCTION kintmoninobuk(displa,z0h,obu,ustar,ztop,zbot)
!-----------------------------------------------------------------------
! !DESCRIPTION:
...
!-----------------------------------------------------------------------
   ...
   attributes(device) SUBROUTINE moninobukini(ur,th,thm,thv,dth,dqh,dthv,zldis,z0m,um,obu)
...
! Initial values of u* and convective velocity
   ...
   attributes(device) real(r8) FUNCTION psi(k,zeta)
...
END MODULE MOD_FrictionVelocity_CUDA
! --------- EOP ------------
