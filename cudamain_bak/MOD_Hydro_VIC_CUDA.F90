MODULE MOD_Hydro_VIC_CUDA
    ...
    ! ******************************************************************************
    attributes(device) SUBROUTINE Runoff_VIC(deltim, porsl, theta_r, hksati, bsw, &
        ...
        integer  :: Nfrost               !/**< Number of frost subareas in model */
        !-----------------------Arguments---------------------------------------
        ...
        CALL compute_vic_runoff(soil_con, ppt*deltim, soil_con%frost_fract, cell, Nfrost)
    ...
    ! *           bottom layer.
    ! ******************************************************************************/
    attributes(device) SUBROUTINE compute_vic_runoff(soil_con, ppt, frost_fract, cell, Nfrost)
        USE MOD_Hydro_VIC_Variables_CUDA
        IMPLICIT NONE
        ...
        integer,  intent(in) :: Nfrost           !/**< Number of frost subareas in model */
    ...
    ! ******************************************************************************
    attributes(device) SUBROUTINE compute_runoff_and_asat(soil_con, moist, inflow, A, runoff)
        USE MOD_Hydro_VIC_Variables_CUDA, only: soil_con_struct, Nlayer
        IMPLICIT NONE
        !-----------------------Arguments---------------------------------------
        type(soil_con_struct), intent(in) :: soil_con
    ...
    ! ******************************************************************************
    attributes(device) SUBROUTINE calc_Q12(Ksat, init_moist, resid_moist, max_moist, expt, Q12)
        IMPLICIT NONE
    ...
    !  *****************************************************************************/
    attributes(device) SUBROUTINE compute_zwt(soil_con,lindex, moist, zwt)
        USE MOD_Hydro_VIC_Variables_CUDA
        IMPLICIT NONE
        !-----------------------Arguments---------------------------------------
        type(soil_con_struct), intent(in) :: soil_con
    ...
    !  *           soil surface.
    !  *****************************************************************************/
    attributes(device) SUBROUTINE wrap_compute_zwt(soil_con, cell)
        USE MOD_Hydro_VIC_Variables_CUDA
        IMPLICIT NONE
