MODULE MOD_TurbulenceLEddy_CUDA
...
!-----------------------------------------------------------------------
   ...
   attributes(device) SUBROUTINE moninobuk_leddy(hu,ht,hq,displa,z0m,z0h,z0q,obu,um, hpbl, &
...
! for 2 meter screen humidity
   ...
   attributes(device) SUBROUTINE moninobukm_leddy(hu,ht,hq,displa,z0m,z0h,z0q,obu,um,displat,z0mt, hpbl, &
...
END MODULE MOD_TurbulenceLEddy_CUDA
! --------- EOP ------------
