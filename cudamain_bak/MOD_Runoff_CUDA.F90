...
CONTAINS
   ...
   attributes(device) SUBROUTINE SurfaceRunoff_SIMTOP (nl_soil,wimp,porsl,psi0,hksati,&
                                    fsatmax,fsatdcf,&
...
! -------------------------------------------------------------------------
   attributes(device) SUBROUTINE SubsurfaceRunoff_SIMTOP (nl_soil, icefrac, dz_soisno, zi_soisno, zwt, rsubst)
...
! -------------------------------------------------------------------------
   attributes(device) SUBROUTINE Runoff_XinAnJiang ( &
   ...
   ! -------------------------------------------------------------------------
   attributes(device) SUBROUTINE Runoff_SimpleVIC ( &
